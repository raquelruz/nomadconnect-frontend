...
export const DayView = ({ day, isOwner, refreshDay, onEdit, onDelete, onAddActivity, onEditActivity }) => {
	if (!day) {
		return (
			<div className="flex h-full items-center justify-center rounded-2xl border bg-bg-card border-slate-200">
	...
	return (
		<section className="rounded-3xl border border-slate-200 bg-bg-card p-6">
