...
export const ExploreHeader = ({ tripCount = 0 }) => {
	const { inputValue, setInputValue, inputDate, setInputDate, search, hasFilters, clear } = useTripSearch();

	useEffect(() => {
		const timer = setTimeout(() => search({ replace: true }), 500);
